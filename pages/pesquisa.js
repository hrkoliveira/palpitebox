  ...
  return (
    <div className='pt-6'>
      ...
      { !sucess && <div className='w-1/5 mx-auto'>
        ...
        <input type="text" className='p-4 block shadow bg-blue-100 my-2 rounded' placeholder='Whatsapp' onChange={onChange} name='Whatsapp' value={form.Whastapp} />
      ...
      { sucess && <div className='w-1/5 mx-auto'>
        <p className='mb-6 bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3 text-center'>Obrigado por contribuí com sua sugestão ou crítica.</p>
        {
        ...
        }
        {
          retorno.showCoupon && <div className='text-center border p-4 mb-4'>
            ...
            <br />
            <span className='italic'>Tire print ou foto dessa tela e apresente ao garçon.</span>
          </div>
        }
      </div> }
    </div>
